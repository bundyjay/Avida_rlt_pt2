...
def create_data_dict(log_name= 'data_dict_phase2_average_fitness_and_average_length_log.txt'):
            ...
            for a_line in average_lines:
                ...
                if final_update_line:
                    ...
                    evolved_population_average_fitness = float(
                        #4. Fitness
                        final_update_info.group(4)
                        )
                    evolved_population_average_length = float(
                        #7. Copied_size
                        final_update_info.group(7)
                        )
                    evolved_data_dict[fitness_key] = {
                        'trait': 'fitness', 
                        'evolved_population_value':
                                Decimal(evolved_population_average_fitness).log10(),
                        'raw_evolved_population_value':
                                Decimal(evolved_population_average_fitness)
                        }
