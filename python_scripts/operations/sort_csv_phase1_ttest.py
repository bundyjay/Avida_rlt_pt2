...
def sort_csv(
    csv_name = 'phase1_ttest_raw.csv',  
    sorted_name= 'phase1_ttest_dataframe.csv'
    ):
    ...
    csv_dataframe = (
        ...
        >> select(
            X.ancestor_seed, 
            X.trait, 
            X.shallow_evolved_population_value_log10,
            X.deep_evolved_population_value_log10
            ) 
        >> arrange(
            X.trait, 
            X.ancestor_seed
    ...
    log_name= 'sort_csv_phase1_ttest_log.txt'
    date_time_year = (
