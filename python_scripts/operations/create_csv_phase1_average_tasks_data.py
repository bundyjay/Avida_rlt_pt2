...
from data_dict_phase1_average_tasks_data import create_data_dict
from sort_csv_phase1_average_tasks_data import sort_csv 
...
def create_csv(
    data_dict= create_data_dict(
        log_name= 'data_dict_phase1_average_tasks_data_log.txt'
        ), 
    csv_name= 'phase1_taverage_tasks_data_raw.csv'
    ):
    ...
    log_name= 'create_csv_phase1_average_tasks_data_log.txt'
    text = (
...
def create_and_sort_csv():
    ...
    yield print(create_csv(
        data_dict= create_data_dict(
            log_name= 
                'data_dict_phase1_average_tasks_data_log.txt'
            ), 
        csv_name= 'phase1_average_tasks_data_raw.csv'
        ))
    yield print(sort_csv(
        csv_name = 'phase1_average_tasks_data_raw.csv', 
        sorted_name= 'phase1_average_tasks_data_dataframe.csv'
        ))
