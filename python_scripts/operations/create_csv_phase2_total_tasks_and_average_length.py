...
from data_dict_phase2_total_tasks_and_average_length import create_data_dict
from sort_csv_phase2_total_tasks_and_average_length import sort_csv 
...
def create_csv(
    ...
    csv_name= 'phase2_total_tasks_and_average_length.csv'
    ):
...
def create_and_sort_csv():
    ...
    yield print(create_csv(
        data_dict= create_data_dict(
            log_name= 
                'data_dict_phase2_total_tasks_and_average_length_log.txt'
            ), 
        csv_name= 'phase2_total_tasks_and_average_length.csv'
        ))
    yield print(sort_csv(
        csv_name = 'phase2_total_tasks_and_average_length.csv', 
        sorted_name= 'phase2_total_tasks_and_average_length_dataframe.csv'
        ))
