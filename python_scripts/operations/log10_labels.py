...
print("10")
print("10","42".translate(superscript).replace(" ", ""))
print("10","42".translate(superscript))
x = ("10","42".translate(superscript))
y = x[1]
print("10³")
...
# def log10_fixed_precision(label):
...
#         print('label_list:', log10_fixed_precision(input_list))
