...
def create_data_dict(log_name='data_dict_phase1_log.txt'):
    ...
    for each_folder in input_folders:       
            ...
            for each_update in trajectory_updates: 
                ...
                fitness_series = 'Depth_%s_Seed_%s_Fitness' % (depth, lineage)
                data_dict[fitness_key] = ({ 
                    ...
                    'time': update, 
                    'trait': 'fitness', 
                    'ancestor_value': fitness, 
                    'ancestor_value_log10': fitness.log10()
                    })
                length_key = (
                    'Depth%s_Seed%s_Update%s_Length'
                    % (depth, lineage, update)
                    )                  
                length_series = 'Depth_%s_Seed_%s_Length' % (depth, lineage)
                data_dict[length_key] = ({ 
                    ...
                    'time': update, 
                    'trait': 'genome_length', 
                    'ancestor_value': genome_length, 
                    'ancestor_value_log10': genome_length.log10()
                    })
            ...
            for each_update in trajectory_updates:
                ...
                if each_update == 0:    
                    ...
                    data_dict[fitness_key].update({
                        ...
                        'average_value_log10': 
                        log10(data_dict[fitness_key]['ancestor_value'])
                        })
                    length_key = (
                        'Depth%s_Seed%s_Update%s_Length' 
                        % (depth, lineage, update)
                    ...
                    data_dict[length_key].update({
                        ...
                        'average_value_log10': 
                        log10(data_dict[length_key]['ancestor_value'])
                        })
                else:
                    fitness_key = (
                        'Depth%s_Seed%s_Update%s_Fitness' 
...
if __name__ == '__main__':
    create_data_dict(log_name='data_dict_phase1_log.txt')  
