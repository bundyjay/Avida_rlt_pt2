...
def sort_csv(
    csv_name = 'phase2_total_average_tasks_data.csv',  
    sorted_name= 'phase2_total_average_tasks_data_dataframe.csv'
    ):
    ...
    log_name= 'sort_csv_phase2_average_tasks_data_log.txt'
    date_time_year = (
