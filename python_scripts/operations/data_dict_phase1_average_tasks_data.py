            ...
            with open(tasks_data_file_location, 'r') as tasks_file:
                ...
                for a_line in tasks_lines:
                    ...
                    if depth_update_line:
                        ...
                        tasks_list = [
                            int(s) for s in depth_update_info.group()
                            .split(' ')
                            ]
                        original_list = [
                            int(s) for s in depth_update_info.group()
                        ...
                        # tasks_list = [500000, 167, 3361, 5, 3507, 112, 3283, 21, 1, 9, 3, 4]
                        # original_list = [500000, 167, 3361, 5, 3507, 112, 3283, 21, 1, 9, 3, 4]
                        ...
                        # print('tasks: ', tasks_total)
                        rewards = sum(tasks_list[1::2])
...
if __name__ == '__main__':
    create_data_dict(
        log_name='data_dict_phase1_average_tasks_data.txt'
        )   