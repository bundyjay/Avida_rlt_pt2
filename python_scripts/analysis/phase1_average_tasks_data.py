...
group_means = (
    ...
    >> summarize(group_mean = X.evolved_population_value.mean(), group_std = X.evolved_population_value.std())
    # >> summarize(group_std = X.evolved_population_value.std())
    )


log_name= 'phase1_average_tasks_data_analysis_log.txt'  
date_time_year = (
