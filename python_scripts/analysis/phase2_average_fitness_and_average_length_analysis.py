...
ACH_phase2_average_fitness_and_average_length_dataframe = read_csv(
    str(project_folder) 
    + '/output_analysis/'
...
"""
group_means = (
    ACH_phase2_average_fitness_and_average_length_dataframe 
    >> group_by(
        X.environment, 
        X.trait, 
        X.depth
...
log_name= 'phase2_average_fitness_and_average_length_analysis_log.txt'
date_time_year = (
