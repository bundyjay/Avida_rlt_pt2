...
from plotnine import aes, element_blank, element_line, element_rect, element_text, facet_wrap, geom_blank, geom_boxplot, geom_crossbar, geom_jitter, geom_point, ggplot, labeller, position_jitterdodge, scale_color_manual, scale_x_log10, scale_y_continuous, theme
...
rewards_median_20k = statistics.median(rewards_20k)
rewards_median_100k = statistics.median(rewards_100k)
rewards_median_500k = statistics.median(rewards_500k)
# print('median_20k', rewards_median_20k)
# print('median_100k', rewards_median_100k)
# print('median_500k', rewards_median_500k)
...
# print('Stat, p_value: ', stat, p_value)
...
nonrewards_median_20k = statistics.median(nonrewards_20k)
nonrewards_median_100k = statistics.median(nonrewards_100k)
nonrewards_median_500k = statistics.median(nonrewards_500k)
...
depths = [20000, 100000, 500000]
values = [nonrewards_median_20k, nonrewards_median_100k, nonrewards_median_500k]
median_dict = {'trait': trait_names, 'depth': depths, 'value': values}  
nonrewards_median_data = DataFrame(median_dict)
# print('median data: ', nonrewards_median_data)

trait_names = ["rewards", "rewards", "rewards", "unrewarded_tasks", "unrewarded_tasks", "unrewarded_tasks" ]
depths = [20000, 100000, 500000, 20000, 100000, 500000]
values = [rewards_median_20k, rewards_median_100k, rewards_median_500k, nonrewards_median_20k, nonrewards_median_100k, nonrewards_median_500k]
median_dict = {'trait': trait_names, 'depth': depths, 'value': values}  
rewards_median_data = DataFrame(median_dict)
# print('median data: ', rewards_median_data)
...
plot_name = 'phase1_facet_functions.pdf'
rewards_plot.save(
    filename = plot_name,
    path = output_folder
    + '/masked/phase1_plot'
...
log_name= 'facet_phase1_average_tasks_plot_log.txt'  
date_time_year = (
