...
sorted_ACH_trajectory_dataframe= read_csv(
    output_folder 
    + '/ACH_trajectory_gestation_dataframe.csv')
final_update = 100000
...
def create_ACH_estimates_bydepth_plot():
    ...
    plot_location = output_folder + '/masked/phase2_plot/combined_footprint_ACH_estimates_gestation_w_traj_plots.tif'
