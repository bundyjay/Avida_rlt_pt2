...
ACH_phase1_average_gestation_and_average_length_dataframe = read_csv(
    str(project_folder) 
    + '/output_analysis/'
    + 'phase1_average_gestation_and_average_length_dataframe.csv'
    )
...
"""
group_means = (
    ACH_phase1_average_gestation_and_average_length_dataframe 
...
log_name= 'phase1_average_gestation_and_average_length_analysis_log.txt'  
date_time_year = (
