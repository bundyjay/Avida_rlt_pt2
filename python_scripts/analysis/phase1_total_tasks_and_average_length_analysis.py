...
ACH_phase1_total_tasks_and_average_length_dataframe = read_csv(
    str(project_folder) 
    + '/output_analysis/'
    + 'phase1_total_tasks_and_average_length_dataframe.csv'
    )
...
"""
group_means = (
    ACH_phase1_total_tasks_and_average_length_dataframe 
    >> group_by(X.trait, X.depth) 
    >> summarize(group_mean = X.evolved_population_value.mean())
    )


log_name= 'phase1_total_tasks_and_average_length_analysis_log.txt'  
date_time_year = (
