...
ACH_trajectory_phase2_dataframe_name = 'phase2_gestation_dataframe.csv'
...
def make_ANOVAandVariance_trajectory_dict():
    ...
    traits = ['gestation', 'genome_length']
...
if __name__ == '__main__':
    ...
    """
    analysis_trajectory_data_dict_name = 'analysis_trajectory_gestation.csv' 
    ...
    """
    ACH_estimate_trajectory_dict_name = 'ACH_estimate_trajectory_gestation.csv' 
    ...
    analysis_dataframe_csv_name = 'analysis_trajectory_gestation_dataframe.csv'
    ...
    sorted_ACH_trajectory_dataframe_csv_name = 'ACH_trajectory_gestation_dataframe.csv'
