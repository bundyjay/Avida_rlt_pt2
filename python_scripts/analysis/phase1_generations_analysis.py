"""
Analyze the Phase 1 generations by depth.

Saves 'phase1_generations_analysis_log.txt'
...
ACH_phase1_generations_dataframe = read_csv(
    str(project_folder) 
    + '/output_analysis/'
    + 'phase1_generations_dataframe.csv'
    )
...
"""
group_means = (
    ACH_phase1_generations_dataframe 
    >> group_by(X.depth) 
    >> summarize(group_mean = X.evolved_population_value.mean())
    )


log_name= 'phase1_generations_analysis_log.txt'  
date_time_year = (
